  ...
  return (
    <section id="key-metrics" className="py-20 lg:py-24 relative overflow-hidden">
      <div className="container max-w-5xl mx-auto px-4">
        <h2 className="text-5xl md:text-6xl text-base-content font-bold text-center mb-12">
          Key Metrics
        </h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mx-auto">
          {metrics.map((metric) => (
            ...
            >
              <div className="mb-4">
                <span className="stat-value text-primary font-extrabold text-3xl sm:text-4xl">
                  {metric.value}
                </span>
              </div>
              ...
              <h1 className="text-2xl sm:text-3xl group-hover:text-accent">{metric.title}</h1>
              </div>
