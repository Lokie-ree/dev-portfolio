  ...
  return (
    <section id="services" className="py-20 lg:py-24 text-base-content">
      <div className="container max-w-5xl mx-auto px-6">
          <h2 className="text-5xl md:text-6xl font-bold text-center mb-12">Services</h2>
        <div className="flex flex-col sm:flex-row sm:grid sm:grid-cols-2 lg:grid-col-3 gap-8">
          {services.map((service) => (
            ...
            <div className="card-body p-6">
              <h2 className="card-title text-xl sm:text-2xl font-bold text-primary group-hover:text-accent mb-2">{service.title}</h2>
